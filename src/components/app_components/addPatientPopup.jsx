  ...
  const handleSubmit = async () => {
    try {
      ...
      const hasMenstrualHistory =
        formValues.menarche ||
        formValues.LMP ||
        formValues.menopause ||
        formValues.leucorrhea ||
        formValues.mensesDuration ||
        formValues.mensesCycle ||
        formValues.mensesFlow ||
        formValues.mensesColor ||
        formValues.mensesCloths ||
        formValues.mensesOdour ||
        formValues.mensesStains ||
        formValues.concomitanceBefore ||
        formValues.concomitanceDuring ||
        formValues.concomitanceAfter;
          ...
          <Row style={{ marginBottom: 16 }} gutter={16}>
            ...
            <Col span={8}>
              <DatePicker
                ...
                value={
                  formValues.dateOfCase ? dayjs(formValues.dateOfCase) : dayjs()
                }
                onChange={(_, dateString) =>
                  updateField("dateOfCase", dateString)
                }
              />
            </Col>
            <Col span={8}>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <Col style={{ marginBottom: 16 }}>
            <TextArea
              placeholder="History of Chief Complaint"
              value={formValues.historyOfChiefComplaint}
              onChange={(e) =>
                updateField("historyOfChiefComplaint", e.target.value)
              }
            />
          </Col>
          <Col style={{ marginBottom: 16 }}>
      ...
      content: (
        <>
          <Row gutter={16} style={{ marginBottom: 10 }}>
            <Col span={8}>
              <Input
                placeholder="Physical Built"
                value={formValues.physicalBuilt}
                onChange={(e) => updateField("physicalBuilt", e.target.value)}
              />
            </Col>
            <Col span={8}>
              <Input
          ...
          <Row gutter={16} style={{ marginBottom: 10 }}>
            <Col span={8}>
              <Input
                placeholder="Nail"
                value={formValues.nail}
                onChange={(e) => updateField("nail", e.target.value)}
              />
            </Col>
            <Col span={8}>
              <Input
          ...
          <Row gutter={16} style={{ marginBottom: 10 }}>
            <Col span={8}>
              <Input
                ...
                value={formValues.cravings}
                onChange={(e) => updateField("cravings", e.target.value)}
              />
            </Col>
            <Col span={8}>
              <Input
                placeholder="Aversions"
                value={formValues.aversions}
                onChange={(e) => updateField("aversions", e.target.value)}
              />
            </Col>
            <Col span={8}>
              <Input
                placeholder="Thirst"
                value={formValues.thirst}
          ...
          <Row gutter={16} style={{ marginBottom: 10 }}>
            <Col span={8}>
              <Input
                ...
                value={formValues.menarche}
                onChange={(e) => updateField("menarche", e.target.value)}
              />
            </Col>
            <Col span={8}>
              <Input
            ...
            <Col span={8}>
              <Input
                ...
                value={formValues.menopause}
                onChange={(e) => updateField("menopause", e.target.value)}
              />
            </Col>
          </Row>
          <Row gutter={16} style={{ marginBottom: 10 }}>
            <Col span={8}>
              <Input
                placeholder="Leucorrhea"
                value={formValues.leucorrhea}
                onChange={(e) => updateField("leucorrhea", e.target.value)}
              />
            </Col>
            <Col span={8}>
              <Input
                placeholder="Menses Duration"
                value={formValues.mensesDuration}
                onChange={(e) => updateField("mensesDuration", e.target.value)}
              />
            </Col>
            <Col span={8}>
              <Input
                placeholder="Menses Cycle"
                value={formValues.mensesCycle}
                onChange={(e) => updateField("mensesCycle", e.target.value)}
              />
            </Col>
          </Row>
          <Row gutter={16} style={{ marginBottom: 10 }}>
            <Col span={8}>
              <Input
                placeholder="Menses Flow"
                value={formValues.mensesFlow}
                onChange={(e) => updateField("mensesFlow", e.target.value)}
              />
            </Col>
            <Col span={8}>
              <Input
                placeholder="Menses Color"
                value={formValues.mensesColor}
                onChange={(e) => updateField("mensesColor", e.target.value)}
              />
            </Col>
            <Col span={8}>
              <Input
                placeholder="Menses Cloths"
                value={formValues.mensesCloths}
                onChange={(e) => updateField("mensesCloths", e.target.value)}
              />
            </Col>
          </Row>
          <Row gutter={16} style={{ marginBottom: 10 }}>
            <Col span={8}>
              <Input
                placeholder="Menses Odour"
                value={formValues.mensesOdour}
                onChange={(e) => updateField("mensesOdour", e.target.value)}
              />
            </Col>
            <Col span={8}>
              <Input
                placeholder="Menses Stains"
                value={formValues.mensesStains}
                onChange={(e) => updateField("mensesStains", e.target.value)}
              />
            </Col>
          </Row>
          ...
          <Row gutter={16} style={{ marginBottom: 10 }}>
            <Col span={8}>
              <Input
                placeholder="Before Menses"
                value={formValues.concomitanceBefore}
                onChange={(e) =>
                  updateField("concomitanceBefore", e.target.value)
                }
              />
            </Col>
            <Col span={8}>
              <Input
                placeholder="During Menses"
                value={formValues.concomitanceDuring}
                onChange={(e) =>
                  updateField("concomitanceDuring", e.target.value)
                }
              />
            </Col>
            <Col span={8}>
              <Input
                placeholder="After Menses"
                value={formValues.concomitanceAfter}
                onChange={(e) =>
                  updateField("concomitanceAfter", e.target.value)
                }
              />
            </Col>
          </Row>
          ...
          <Row gutter={16}>
            <Col span={8}>
              <Input
                placeholder="Sexual Functions"
                value={formValues.sexualFunctions}
                onChange={(e) => updateField("sexualFunctions", e.target.value)}
              />
            </Col>
          </Row>
        </>
      ...
      content: (
        <>
          ...
          <Row gutter={16}>
            <Col span={8}>
              <Input
                placeholder="Thermals"
                value={formValues.thermals}
                onChange={(e) => updateField("thermals", e.target.value)}
              />
            </Col>
            <Col span={8}>
              <Input
