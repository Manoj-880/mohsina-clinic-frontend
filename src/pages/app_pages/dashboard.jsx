...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard">
      ...
      >
        <AddPatientPopup
          onFinish={() => setShowAddPatientPopup(false)}
          fetchPatients={fetchPatientData}
        />
      </Modal>
      <Modal
        title="Add Follow-Up"
      ...
      >
        <AddFollowUp
          onClose={() => setShowAddFollowUpPopup(false)}
          fetchFollowups={fetchPatientData}
        />
      </Modal>
      <Modal
      ...
      >
        <AddDocument
          ...
          fetchDocuments={fetchPatientData}
        />
      </Modal>
      ...
      <div className="dashboard-row quick-actions-row">
        ...
        <Button
          className="quick-action-btn"
          onClick={() => setShowAddFollowUpPopup(true)}
        >
          + Add FollowUp
        </Button>
        <Button
